// FIXME: Fails to compile after upgrading to futures-lite; poll method signature with context needs adjustment.
/*
...
fn given_sm_with_context_can_take_context_on_ready() {
    ...
    assert_eq!(util::poll(&mut machine), Poll::Ready(Ok(())));
}
*/
